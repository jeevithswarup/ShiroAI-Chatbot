...
<svg
  ...
  <!-- Floating dots near progress -->
  <circle cx="170" cy="520" r="3" fill="#38BDF8">
    <animate attributeName="cy" values="520;480;520" dur="2s" repeatCount="indefinite"/>
  </circle>
  <circle cx="160" cy="535" r="2" fill="#38BDF8">
    <animate attributeName="cy" values="535;495;535" dur="2.3s" repeatCount="indefinite"/>
  </circle>
  <circle cx="180" cy="545" r="2" fill="#38BDF8">
    <animate attributeName="cy" values="545;505;545" dur="1.9s" repeatCount="indefinite"/>
  </circle>
</svg>
